...
"
        ...
        <div className="sm:w-1/2 p-5">
          <div className="text">
            ...
            ABOUT <span className="text-indigo-600">Poonam Oil Industries</span>
            </h2>
            <p className="text-gray-700">
            At Poonam Oil Industries, we take immense pride in producing premium-quality healthcare mustard oil that caters to the well-being of our consumers. Established in 2023, our company has quickly emerged as a trusted name in the mustard oil manufacturing industry, embodying a commitment to excellence and health-conscious choices.
            </p>
          </div>
        </div>
      </div>
      <div className='para'>
      <p  className="text-gray-700"><VerifiedIcon style={{color:"#007FFF"}}/> <b> Our Mission</b> </p>
      </div>
      <div className='para1'>
      <p style={{paddingTop:"1rem"}}> Our mission is to provide households with a range of mustard oil products that not only enhance the flavor and aroma of traditional dishes but also contribute to a healthier lifestyle. We understand the significance of the right ingredients in promoting well-being, and our mission is to make healthcare mustard oil an integral part of every kitchen.</p>
     
      </div>
      <div className='para'>
      <p  className="text-gray-700" style={{paddingTop:"2rem"}}><VerifiedIcon style={{color:"#007FFF"}}/> <b>Quality and Purity</b></p>
      <p style={{paddingTop:"1rem"}}>At the heart of our brand is the pursuit of quality and purity. Our mustard oil is meticulously extracted from the finest mustard seeds using state-of-the-art technology and stringent quality control measures. We ensure that every drop of our oil is free from harmful additives, chemicals, and preservatives, preserving the natural goodness of mustard seeds.</p>
</div>
<div className='para'>
      <p  className="text-gray-700" style={{paddingTop:"2rem"}}><VerifiedIcon style={{color:"#007FFF"}}/> <b>Health and Well-being</b></p>
      <p style={{paddingTop:"1rem"}}>Health is at the forefront of our brand philosophy. Our healthcare mustard oil is packed with essential nutrients, including omega-3 fatty acids, vitamins, and antioxidants, which contribute to cardiovascular health, improved digestion, and overall well-being. We are committed to empowering individuals to make conscious choices that benefit their health.</p>
</div>
<div className='para'>
      <p  className="text-gray-700" style={{paddingTop:"2rem"}}><VerifiedIcon style={{color:"#007FFF"}}/> <b>Sustainability and Responsibility</b></p>
      <p style={{paddingTop:"1rem"}}>Poonam Oil Industries is dedicated to sustainable practices that support the environment and communities we serve. We source our mustard seeds from local farmers who follow responsible agricultural practices. Our manufacturing processes are designed to minimize waste and energy consumption, aligning with our commitment to a greener future.</p>
</div>
<div className='para'>
      <p  className="text-gray-700" style={{paddingTop:"2rem"}}><VerifiedIcon style={{color:"#007FFF"}}/> <b>Customer Satisfaction</b></p>
      <p style={{paddingTop:"1rem"}}>We value our customers' trust and satisfaction above all else. Our team of experts works tirelessly to ensure that every bottle of healthcare mustard oil that reaches your kitchen exceeds your expectations. We listen to our customers' feedback and continuously strive to improve our products and services.</p>
</div>
<div className='para'>
      <p  className="text-gray-700" style={{paddingTop:"2rem"}}><VerifiedIcon style={{color:"#007FFF"}}/> <b>Innovation and Tradition</b></p>
      <p style={{paddingTop:"1rem"}}>Poonam Oil Industries embraces the synergy between innovation and tradition. While we leverage cutting-edge technology for oil extraction and packaging, we remain rooted in the timeless traditions of mustard oil production. This harmonious blend allows us to offer a product that is both modern and authentic.</p>
</div>
<div className='para'>
      <p  className="text-gray-700" style={{paddingTop:"2rem"}}><VerifiedIcon style={{color:"#007FFF"}}/> <b>Join Us on the Journey to Better Health</b></p>
      <p style={{padding:"1rem 0rem"}}>We invite you to join us on our journey to better health through conscious culinary choices. Explore the unique flavors and health benefits of our healthcare mustard oil, and experience the difference it can make in your everyday life.<br/><br/>Thank you for choosing Poonam Oil Industries, where quality, health, and your satisfaction are our top priorities.</p>
</div>
    <Footer/>
    </div>
  );
